...
from yolov8.cfg import TASK2DATA, get_cfg
from yolov8.data import build_dataloader
from yolov8.data.dataset import YOLODataset
from yolov8.data.utils import check_cls_dataset, check_det_dataset
from yolov8.nn.autobackend import check_class_names, default_class_names
from yolov8.nn.modules import C2f, Detect, RTDETRDecoder
from yolov8.nn.tasks import DetectionModel, SegmentationModel, WorldModel
...
from yolov8.utils.downloads import attempt_download_asset, get_github_assets, safe_download
from yolov8.utils.files import file_size, spaces_in_path
from yolov8.utils.ops import Profile
from yolov8.utils.torch_utils import TORCH_1_13, get_latest_opset, select_device, smart_inference_mode
    ...
    def __call__(self, model=None) -> str:
        ...
        if isinstance(model, WorldModel):
            LOGGER.warning(
                ...
                "See https://docs.yolov8.com/models/yolo-world for details."
            )
    ...
    def export_engine(self, prefix=colorstr("TensorRT:")):
        ...
        if int8:
            ...
            class EngineCalibrator(trt.IInt8Calibrator):
                def __init__(
                    self,
                    dataset,  # yolov8.data.build.InfiniteDataLoader
                    batch: int,
                    cache: str = "",
                ) -> None:

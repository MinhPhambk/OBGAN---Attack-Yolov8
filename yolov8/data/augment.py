...
from yolov8.data.utils import polygons2masks, polygons2masks_overlap
...
from yolov8.utils.ops import segment2box, xyxyxyxy2xywhr
from yolov8.utils.torch_utils import TORCHVISION_0_10, TORCHVISION_0_11, TORCHVISION_0_13
...
class Compose:
    ...
    def __init__(self, transforms):
        ...
        Examples:
            >>> from yolov8.data.augment import Compose, RandomHSV, RandomFlip
...
class Mosaic(BaseMixTransform):
    ...
    Examples:
        >>> from yolov8.data.augment import Mosaic
...
class MixUp(BaseMixTransform):
    ...
    Examples:
        >>> from yolov8.data.augment import MixUp
        >>> dataset = YourDataset(...)  # Your image dataset
...
class RandomHSV:
    ...
    Examples:
        >>> import numpy as np
        >>> from yolov8.data.augment import RandomHSV
    ...
    def __call__(self, labels):
        ...
        Args:
            labels (Dict): A dictionary containing the following keys:
                ...
                'instances' (yolov8.utils.instance.Instances): An object containing bounding boxes and
                    optionally keypoints.

        Returns:
            (Dict): The same dictionary with the flipped image and updated instances:
                'img' (numpy.ndarray): The flipped image.
                'instances' (yolov8.utils.instance.Instances): Updated instances matching the flipped image.
    ...
    def __call__(self, labels):
        ...
        Args:
            labels (Dict): A dictionary containing:
                ...
                - 'instances' (yolov8.engine.results.Instances): Object containing bounding boxes, segments, etc.

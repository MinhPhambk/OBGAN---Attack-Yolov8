...
from yolov8.hub import HUB_WEB_ROOT, HUBTrainingSession
...
class Model(nn.Module):
    ...
    def __init__(
        ...
        Args:
            model (Union[str, Path]): Path or name of the model to load or create. Can be a local file path, a
                model name from yolov8 HUB, or a Triton Server model.
    ...
    def __call__(
        ...
        **kwargs,
        ...
        Returns:
            (List[yolov8.engine.results.Results]): A list of prediction results, each encapsulated in a
                Results object.

        Examples:
            >>> model = YOLO('yolov8n.pt')
            >>> results = model('https://yolov8.com/images/bus.jpg')
            >>> for r in results:
    ...
    def is_hub_model(model: str) -> bool:
        ...
        Examples:
            >>> Model.is_hub_model("https://hub.yolov8.com/models/example_model")
            True
    ...
    def save(self, filename: Union[str, Path] = "saved_model.pt", use_dill=True) -> None:
        ...
        updates = {
            ...
            "version": __version__,
            "license": "AGPL-3.0 License (https://yolov8.com/license)",
    ...
    def embed(
        ...
        **kwargs,
        ...
        Examples:
            >>> model = YOLO('yolov8n.pt')
            >>> image = 'https://yolov8.com/images/bus.jpg'
    ...
    def track(
        ...
        **kwargs,
        ...
        Returns:
            (List[yolov8.engine.results.Results]): A list of tracking results, each a Results object.
    ...
    def val(
        ...
        **kwargs,
        ...
        Args:
            validator (yolov8.engine.validator.BaseValidator | None): An instance of a custom validator class for
                validating the model.
            **kwargs (Any): Arbitrary keyword arguments for customizing the validation process.

        Returns:
            (yolov8.utils.metrics.DetMetrics): Validation metrics obtained from the validation process.
    ...
    def benchmark(
        ...
        **kwargs,
        ...
        It uses the 'benchmark' function from the yolov8.utils.benchmarks module. The benchmarking is
    ...
    def tune(
        ...
        **kwargs,
        ...
        When Ray Tune is enabled, it leverages the 'run_ray_tune' function from the yolov8.utils.tuner module.
    ...
    def names(self) -> list:
        ...
        using the 'check_class_names' function from the yolov8.nn.autobackend module. If the predictor is not

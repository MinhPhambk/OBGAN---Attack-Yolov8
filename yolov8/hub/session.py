...
from yolov8.hub.utils import HELP_MSG, HUB_WEB_ROOT, PREFIX, TQDM
from yolov8.utils import IS_COLAB, LOGGER, SETTINGS, __version__, checks, emojis
...
class HUBTrainingSession:
    ...
    Attributes:
        ...
        model (dict): Model data fetched from yolov8 HUB.
    """
    ...
    def load_model(self, model_id):
        """Loads an existing model from yolov8 HUB using the provided model identifier."""

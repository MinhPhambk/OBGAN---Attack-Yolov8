...
from yolov8.data.augment import Format
from yolov8.data.dataset import YOLODataset
from yolov8.data.utils import check_det_dataset
from yolov8.models.yolo.model import YOLO
from yolov8.utils import LOGGER, USER_CONFIG_DIR, IterableSimpleNamespace, checks
...
class Explorer:
    ...
    def query(
        ...
        Example:
            ...
            exp = Explorer()
            exp.create_embeddings_table()
            similar = exp.query(img='https://yolov8.com/images/zidane.jpg')
            ```
        """
    ...
    def get_similar(
        ...
        Example:
            ...
            exp = Explorer()
            exp.create_embeddings_table()
            similar = exp.get_similar(img='https://yolov8.com/images/zidane.jpg')
            ```
        """
    ...
    def plot_similar(
        ...
        Example:
            ...
            exp = Explorer()
            exp.create_embeddings_table()
            similar = exp.plot_similar(img='https://yolov8.com/images/zidane.jpg')
            ```
        """

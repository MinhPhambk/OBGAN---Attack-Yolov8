...
from yolov8 import Explorer
from yolov8.utils import ROOT, SETTINGS
...
def utralytics_explorer_docs_callback():
    ...
    with st.container(border=True):
        ...
        st.markdown(
            "<p>This demo is built using Ultralytics Explorer API. Visit <a href='https://docs.yolov8.com/datasets/explorer/'>API docs</a> to try examples & learn more</p>",
            unsafe_allow_html=True,
            help=None,
        )
        st.link_button("Ultrlaytics Explorer API", "https://docs.yolov8.com/datasets/explorer/")
